...
public class CropSliderViewFront extends CircularSliderView{
    ...
    public CropSliderViewFront(Context context) {
        super(context);
        this.context =(Activity) context;
        init(null, 0);
    }

    public CropSliderViewFront(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = (Activity)context;
        init(attrs, 0);
    }

    public CropSliderViewFront(Context context, AttributeSet attrs, int defStyle) {
...
//        a.recycle();
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        waveStart = mPadding + mBorderThickness + 10;
        waveEnd = w - mPadding - mBorderThickness - 10;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // draw png */
        soundWave.setBounds((int)(waveStart-waveOffset), waveTop, (int) (waveStart + image_width-waveOffset), waveBottom);
        ...
        canvas.drawLine(waveStart-10, waveTop, mPadding + mBorderThickness + 2*mCircleRadius, waveTop, mPaint);
        canvas.drawLine(waveStart - 10, waveBottom, mPadding + mBorderThickness + 2 * mCircleRadius, waveBottom, mPaint);
    ...
    protected void updateSliderState(int touchX, int touchY) {
        ...
        timeText = (TextView) context.findViewById(R.id.timeF);
    ...
    public String getTime() {
        int min = (int)secondsOffset/60;
        int sec = (int)secondsOffset % 60;
